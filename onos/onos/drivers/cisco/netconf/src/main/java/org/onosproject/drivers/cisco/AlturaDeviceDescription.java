...
public class AlturaDeviceDescription extends AbstractHandlerBehaviour
    ...
    public DeviceDescription discoverDeviceDetails() {
        ...
        System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAYUDA");
        log.warn("HOLA0 {}", details[0]);
        log.warn("HOLA1 {}", details[1]);
        log.warn("HOLA2 {}", details[2]);
        log.warn("Devchasis {}",  device.chassisId());
        log.error("HOLA3 {}", details[3]);
    ...
    private String showVersionRequestBuilder() {
        ...
        rpc.append("<helloworld-state xmlns=\"http://helloworld.com/ns/helloworld\">");
        rpc.append("</helloworld-state>");
        rpc.append("</filter>");
        rpc.append("</get>");
        rpc.append("</rpc>");
        return rpc.toString();
