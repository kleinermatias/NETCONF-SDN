...
#define NETSNMP_CONFIGURE_OPTIONS " '--host=nios2-linux-gnu' '--prefix=/mxp/app/snmp' '--disable-manuals' '--disable-scripts' '--with-endianess=little' '--with-cflags=-O0' '--with-ldflags=-elf2flt' '--disable-embedded-perl--without-perl-modules' '--with-mib-modules=FTNC-MIB/notifications/ftnc_notifications edfaTable fanTable mxpEnvTable powerTable txpAlrmRxTable txpAlrmTxTable txpBandTable txpChannelTable txpDSPCompensationTable txpDSPErrorsTable txpDSPStatusTable txpPhyspadTable txpPowerTable txpPowSupplyAlrmTable txpTempTable xfp1Table xfp2Table xfp3Table xfp4Table' '--enable-mini-agent' '--with-defaults' 'host_alias=nios2-linux-gnu'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/mxp/app/snmp/share/snmp/mibs"
...
#define NETSNMP_DEFAULT_MIBS ":SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:FTNC-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-FRAMEWORK-MIB"
...
#define SNMPLIBPATH "/mxp/app/snmp/lib/snmp"
#define SNMPSHAREPATH "/mxp/app/snmp/share/snmp"
#define SNMPCONFPATH "/mxp/app/snmp/etc/snmp"
#define SNMPDLMODPATH "/mxp/app/snmp/lib/snmp/dlmod"
...
#define NETSNMP_SYS_CONTACT "@fulgor"
