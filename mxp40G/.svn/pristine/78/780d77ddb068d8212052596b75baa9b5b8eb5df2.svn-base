...
------------------------------------------------------------------------
  ...
  the txpPowerTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpPowerTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      txpPowerTable_allocate_data
      txpPowerTable_release_data
 ...
 Index(es) for the txpPowerTable table
  ------------------------------------------------------------
  The index(es) for the txpPowerTable table are:
...
************************************************************************
txpPowerTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpPowerTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpPowerTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpPowerTable_data_access file contains the interface to your data in
  ...
  FUNC : txpPowerTable_indexes_set
  WHERE: txpPowerTable_data_access.c
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the txpPowerTable table.

To watch the flow of the txpPowerTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpPowerTable
        verbose:txpPowerTable
        internal:txpPowerTable

e.g.
        snmpd -f -Le -DtxpPowerTable,verbose:txpPowerTable,internal:txpPowerTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpPowerEntry.txpPowerIndex
 * txpPowerIndex is subid 1 of txpPowerEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.2.2.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpPowerIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
