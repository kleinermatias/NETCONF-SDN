...
int t40_testbench_main(void)
{
  ...
  {
    JUST_LOG(LOG_ERR, "T41", "Error opening module.\n");
    return (-1);
  }
  ...
  JUST_LOG(LOG_INFO, "T41", "Full Chip Statistics Dump\n");
...
void print_status(cs_status status)
{
  if (status == CS_OK)
  {
    JUST_LOG(LOG_INFO, "T41", "CS_OK\n");
  }
  else
  {
    JUST_LOG(LOG_ERR, "T41", ">>>> CS_ERROR\n");
  }
}
#endif
