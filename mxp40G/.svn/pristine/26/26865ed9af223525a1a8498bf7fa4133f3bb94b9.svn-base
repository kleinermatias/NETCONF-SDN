...
------------------------------------------------------------------------
  ...
  the tpLineSeverityTable table.  The agent will start by looking for the right
  ...
  file defaults/table-tpLineSeverityTable.m2d, and then re-running mib2c.
    ...
    in the tpLineSeverityTable.h header.
 ...
 Index(es) for the tpLineSeverityTable table
  ------------------------------------------------------------
  The index(es) for the tpLineSeverityTable table are:
...
************************************************************************
tpLineSeverityTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the tpLineSeverityTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: tpLineSeverityTable_data_access.[c|h]
------------------------------------------------------------------------
  The tpLineSeverityTable_data_access file contains the interface to your data in
  ...
  FUNC : tpLineSeverityTable_indexes_set
  WHERE: tpLineSeverityTable_data_access.c
...
File: tpLineSeverityTable_enums.h
------------------------------------------------------------------------
...
File: tpLineSeverityTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerFsmms_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerFsmmtrb1s_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerFsmmtrb2s_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerFsmmtrb3s_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerSoof_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerSlof_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerSif_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityFramerFst_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityLosstatLosf_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityPathmonAccstat_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityPathmonDais_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityPathmonDbdi_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityPathmonDlck_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeverityPathmonMsiunst_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeveritySecmonBipsfs_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeveritySecmonDbdi_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeveritySecmonDiae_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeveritySecmonFlom_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : tpLineSeveritySecmonLom_get



File: tpLineSeverityTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-tpLineSeverityTable.m2d
  ...
  FUNC : tpLineSeverityTable_undo_setup
  ...
  FUNC : tpLineSeverityFramerFsmms_check_value
  ...
  FUNC : tpLineSeverityFramerFsmms_undo_setup
  ...
  FUNC : tpLineSeverityFramerFsmms_set
  ...
  FUNC : tpLineSeverityFramerFsmms_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityFramerFsmmtrb1s_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityFramerFsmmtrb1s_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityFramerFsmmtrb1s_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityFramerFsmmtrb1s_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityFramerFsmmtrb2s_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityFramerFsmmtrb2s_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityFramerFsmmtrb2s_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityFramerFsmmtrb2s_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityFramerFsmmtrb3s_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityFramerFsmmtrb3s_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityFramerFsmmtrb3s_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityFramerFsmmtrb3s_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityFramerSoof_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityFramerSoof_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityFramerSoof_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityFramerSoof_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityFramerSlof_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityFramerSlof_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityFramerSlof_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityFramerSlof_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityFramerSif_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityFramerSif_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityFramerSif_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityFramerSif_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityFramerFst_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityFramerFst_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityFramerFst_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityFramerFst_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityLosstatLosf_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityLosstatLosf_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityLosstatLosf_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityLosstatLosf_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityPathmonAccstat_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityPathmonAccstat_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityPathmonAccstat_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityPathmonAccstat_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityPathmonDais_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityPathmonDais_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityPathmonDais_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityPathmonDais_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityPathmonDbdi_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityPathmonDbdi_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityPathmonDbdi_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityPathmonDbdi_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityPathmonDlck_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityPathmonDlck_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityPathmonDlck_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityPathmonDlck_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeverityPathmonMsiunst_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeverityPathmonMsiunst_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeverityPathmonMsiunst_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeverityPathmonMsiunst_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeveritySecmonBipsfs_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeveritySecmonBipsfs_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeveritySecmonBipsfs_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeveritySecmonBipsfs_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeveritySecmonDbdi_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeveritySecmonDbdi_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeveritySecmonDbdi_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeveritySecmonDbdi_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeveritySecmonDiae_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeveritySecmonDiae_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeveritySecmonDiae_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeveritySecmonDiae_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeveritySecmonFlom_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeveritySecmonFlom_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeveritySecmonFlom_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeveritySecmonFlom_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : tpLineSeveritySecmonLom_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : tpLineSeveritySecmonLom_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : tpLineSeveritySecmonLom_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : tpLineSeveritySecmonLom_undo
  ...
  --------------
  TODO : commit changes
  FUNC : tpLineSeverityTable_commit
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      tpLineSeverityTable table.

      Conversely, the examples below may not include some functions that
      were generated for the tpLineSeverityTable table.

To watch the flow of the tpLineSeverityTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        tpLineSeverityTable
        verbose:tpLineSeverityTable
        internal:tpLineSeverityTable

e.g.
        snmpd -f -Le -DtpLineSeverityTable,verbose:tpLineSeverityTable,internal:tpLineSeverityTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::tpLineSeverityEntry.tpLineSeverityIndex
 * tpLineSeverityIndex is subid 1 of tpLineSeverityEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.1.1.3.6.1.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE tpLineSeverityIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
