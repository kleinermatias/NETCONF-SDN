...
begin with the tpClient2SeverityTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : tpClient2SeverityTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f tpClient2SeverityTable_Makefile


  File    : tpClient2SeverityTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   tpClient2SeverityTable-README-tpClient2SeverityTable.txt
...
------------------------------------------------------------------------
  ...
  File    : tpClient2SeverityTable_interface.c
