************************************************************************
txpDSPCompensationTable README
------------------------------------------------------------------------
  ...
  the txpDSPCompensationTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpDSPCompensationTable.m2d, and then re-running mib2c.
    ...
    in the txpDSPCompensationTable.h header.
    ...
    will be generated:
      ...
      txpDSPCompensationTable_allocate_data
      txpDSPCompensationTable_release_data
 ...
 Index(es) for the txpDSPCompensationTable table
  ------------------------------------------------------------
  The index(es) for the txpDSPCompensationTable table are:

     txpDSPCompensationIndex:
        Syntax:      OCTETSTR
        DataType:    OCTETSTR
...
************************************************************************
txpDSPCompensationTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpDSPCompensationTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpDSPCompensationTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpDSPCompensationTable_data_access file contains the interface to your data in
  ...
  FUNC : txpDSPCompensationTable_indexes_set
  WHERE: txpDSPCompensationTable_data_access.c
...
File: txpDSPCompensationTable_enums.h
------------------------------------------------------------------------
...
File: txpDSPCompensationTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : minBulkCDCompensation_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : maxBulkCDCompensation_get
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cdCompensation_get



File: txpDSPCompensationTable_data_set.c
------------------------------------------------------------------------
...
************************************************************************
txpDSPCompensationTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      txpDSPCompensationTable table.

      Conversely, the examples below may not include some functions that
      were generated for the txpDSPCompensationTable table.

To watch the flow of the txpDSPCompensationTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpDSPCompensationTable
        verbose:txpDSPCompensationTable
        internal:txpDSPCompensationTable

e.g.
        snmpd -f -Le -DtxpDSPCompensationTable,verbose:txpDSPCompensationTable,internal:txpDSPCompensationTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpDSPCompensationEntry.txpDSPCompensationIndex
 * txpDSPCompensationIndex is subid 1 of txpDSPCompensationEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.3.3.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpDSPCompensationIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
