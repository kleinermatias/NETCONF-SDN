...
------------------------------------------------------------------------
  ...
  the txpDSPErrorsTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpDSPErrorsTable.m2d, and then re-running mib2c.
    ...
    in the txpDSPErrorsTable.h header.
    ...
    will be generated:
      ...
      txpDSPErrorsTable_allocate_data
      txpDSPErrorsTable_release_data
 ...
 Index(es) for the txpDSPErrorsTable table
  ------------------------------------------------------------
  The index(es) for the txpDSPErrorsTable table are:
...
************************************************************************
txpDSPErrorsTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpDSPErrorsTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpDSPErrorsTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpDSPErrorsTable_data_access file contains the interface to your data in
  ...
  FUNC : txpDSPErrorsTable_indexes_set
  WHERE: txpDSPErrorsTable_data_access.c
...
File: txpDSPErrorsTable_enums.h
------------------------------------------------------------------------
...
File: txpDSPErrorsTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : berestimate_get



File: txpDSPErrorsTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      txpDSPErrorsTable table.

      Conversely, the examples below may not include some functions that
      were generated for the txpDSPErrorsTable table.

To watch the flow of the txpDSPErrorsTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpDSPErrorsTable
        verbose:txpDSPErrorsTable
        internal:txpDSPErrorsTable

e.g.
        snmpd -f -Le -DtxpDSPErrorsTable,verbose:txpDSPErrorsTable,internal:txpDSPErrorsTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpDSPErrorsEntry.txpDSPErrorsIndex
 * txpDSPErrorsIndex is subid 1 of txpDSPErrorsEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.3.2.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpDSPErrorsIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
