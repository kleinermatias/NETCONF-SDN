 ...
 *
 * $Id: ten_xcon.c,v 1.42 2013/10/18 13:39:30 khill Exp $
 *
 */
  ...
  for (ii=0; ii<TEN_XCON_PBERT_RX_COUNT; ii++) {
    if ((es_num == ii) || (es_num == XCON_ELASTIC_STORE_ALL)) {
      ...
      if (profile == XCON_PBERT_PROFILE_FC) {                               
        ...
        /* Bug 41565 Start - Switch FC from Fixed Pattern to PRBS */
        /* tmp_pbert_rx_pctrl_fr.bf.prbs_inv = 1; */
        tmp_pbert_rx_pctrl_fr.bf.prbs_inv = 0;
        tmp_pbert_rx_pctrl_fr.bf.type = 0;
        ...
        tmp_pbert_tx_pctrl_fr.bf.prbs_inv = 0;
        tmp_pbert_tx_pctrl_fr.bf.type = 0;
        /* Bug 41565 End */
