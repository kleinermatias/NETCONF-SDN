...
------------------------------------------------------------------------
  ...
  the xfp3SeverityTable table.  The agent will start by looking for the right
  ...
  file defaults/table-xfp3SeverityTable.m2d, and then re-running mib2c.
    ...
    in the xfp3SeverityTable.h header.
 ...
 Index(es) for the xfp3SeverityTable table
  ------------------------------------------------------------
  The index(es) for the xfp3SeverityTable table are:
...
************************************************************************
xfp3SeverityTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the xfp3SeverityTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: xfp3SeverityTable_data_access.[c|h]
------------------------------------------------------------------------
  The xfp3SeverityTable_data_access file contains the interface to your data in
  ...
  FUNC : xfp3SeverityTable_indexes_set
  WHERE: xfp3SeverityTable_data_access.c
...
File: xfp3SeverityTable_enums.h
------------------------------------------------------------------------
...
File: xfp3SeverityTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityPresence_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityRxLoss_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityReady_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityTxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityRxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityTemperature_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityLowTxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityHighTxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityLowRxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityHighRxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityRxCdrLossOfLock_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityTxCdrLossOfLock_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp3SeverityLaserFault_get



File: xfp3SeverityTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-xfp3SeverityTable.m2d
  ...
  FUNC : xfp3SeverityTable_undo_setup
  ...
  FUNC : xfp3SeverityPresence_check_value
  ...
  FUNC : xfp3SeverityPresence_undo_setup
  ...
  FUNC : xfp3SeverityPresence_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityRxLoss_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityRxLoss_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityReady_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityReady_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityTxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityTxPower_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityRxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityRxPower_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityTemperature_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityTemperature_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityTemperature_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityTemperature_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityLowTxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityLowTxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityLowTxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityLowTxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityHighTxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityHighTxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityHighTxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityHighTxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityLowRxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityLowRxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityLowRxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityLowRxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityHighRxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityHighRxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityHighRxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityHighRxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityRxCdrLossOfLock_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityRxCdrLossOfLock_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityRxCdrLossOfLock_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityRxCdrLossOfLock_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityTxCdrLossOfLock_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityTxCdrLossOfLock_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityTxCdrLossOfLock_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityTxCdrLossOfLock_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp3SeverityLaserFault_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp3SeverityLaserFault_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp3SeverityLaserFault_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp3SeverityLaserFault_undo
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      xfp3SeverityTable table.

      Conversely, the examples below may not include some functions that
      were generated for the xfp3SeverityTable table.

To watch the flow of the xfp3SeverityTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        xfp3SeverityTable
        verbose:xfp3SeverityTable
        internal:xfp3SeverityTable

e.g.
        snmpd -f -Le -Dxfp3SeverityTable,verbose:xfp3SeverityTable,internal:xfp3SeverityTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::xfp3SeverityEntry.xfp3SeverityIndex
 * xfp3SeverityIndex is subid 1 of xfp3SeverityEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.1.1.3.5.3.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE xfp3SeverityIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
