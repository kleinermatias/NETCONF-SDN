 ...
 *
 * $Id: ten_hl_config_10ge_t41.c,v 1.41 2014/04/02 19:06:43 pptawade Exp $
 *
 */
...
/****************************************************************/
{
  ...
  if ((traffic_type_client != TEN_TRAFFIC_TYPE_10GE_WAN) && (traffic_type_client != TEN_TRAFFIC_TYPE_10GE_6_2) &&
      ...
      (traffic_type_client != TEN_TRAFFIC_TYPE_10GE_TC) && (traffic_type_client != TEN_TRAFFIC_TYPE_10GE) &&
  ...
  /* Bug #40141: Support 10GE GMP_LO */
  if (traffic_type_client == TEN_TRAFFIC_TYPE_10GE) {
    tmp_map_oxuv = TEN_MAP_GMP_LO;
  }
  else {
    tmp_map_oxuv =  TEN_MAP_BMP;
  }
...
/****************************************************************/
{
  ...
  if ((traffic_type_client != TEN_TRAFFIC_TYPE_10GE_WAN) && (traffic_type_client != TEN_TRAFFIC_TYPE_10GE_6_2) &&
      ...
      (traffic_type_client != TEN_TRAFFIC_TYPE_1GE) && (traffic_type_client != TEN_TRAFFIC_TYPE_10GE) &&    /* Bugzilla 38871 */
      (traffic_type_client != TEN_TRAFFIC_TYPE_CBR_10G)) {  /* Bugzilla 43573 */
    CS_HNDL_ERROR(module_id_line, ETEN_MOD_INVALID_USER_ARG, "%s() traffic_type_client %d out of range.  s/b 9, 10, 11, 12, 20, 26, 27, 28, 30.", func, traffic_type_client);
    return (CS_ERROR);
  }
  ...
  if ((map_odtu == TEN_MAP_GMP_HO) || (map_odtu == TEN_MAP_GMP_HO_DT)) {
    ...
    /* Bug #40141, suppport 10ge_ra using GMP_LO */
    /* timeslots = 4; */
  }  
