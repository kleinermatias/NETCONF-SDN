...
------------------------------------------------------------------------
  ...
  the xfp2SeverityTable table.  The agent will start by looking for the right
  ...
  file defaults/table-xfp2SeverityTable.m2d, and then re-running mib2c.
    ...
    in the xfp2SeverityTable.h header.
 ...
 Index(es) for the xfp2SeverityTable table
  ------------------------------------------------------------
  The index(es) for the xfp2SeverityTable table are:
...
************************************************************************
xfp2SeverityTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the xfp2SeverityTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: xfp2SeverityTable_data_access.[c|h]
------------------------------------------------------------------------
  The xfp2SeverityTable_data_access file contains the interface to your data in
  ...
  FUNC : xfp2SeverityTable_indexes_set
  WHERE: xfp2SeverityTable_data_access.c
...
File: xfp2SeverityTable_enums.h
------------------------------------------------------------------------
...
File: xfp2SeverityTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityPresence_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityRxLoss_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityReady_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityTxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityRxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityTemperature_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityLowTxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityHighTxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityLowRxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityHighRxPower_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityRxCdrLossOfLock_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityTxCdrLossOfLock_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2SeverityLaserFault_get



File: xfp2SeverityTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-xfp2SeverityTable.m2d
  ...
  FUNC : xfp2SeverityTable_undo_setup
  ...
  FUNC : xfp2SeverityPresence_check_value
  ...
  FUNC : xfp2SeverityPresence_undo_setup
  ...
  FUNC : xfp2SeverityPresence_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityRxLoss_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityRxLoss_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityReady_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityReady_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityTxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityTxPower_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityRxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityRxPower_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityTemperature_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityTemperature_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityTemperature_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityTemperature_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityLowTxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityLowTxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityLowTxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityLowTxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityHighTxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityHighTxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityHighTxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityHighTxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityLowRxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityLowRxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityLowRxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityLowRxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityHighRxPower_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityHighRxPower_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityHighRxPower_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityHighRxPower_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityRxCdrLossOfLock_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityRxCdrLossOfLock_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityRxCdrLossOfLock_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityRxCdrLossOfLock_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityTxCdrLossOfLock_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityTxCdrLossOfLock_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityTxCdrLossOfLock_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityTxCdrLossOfLock_undo
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : xfp2SeverityLaserFault_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : xfp2SeverityLaserFault_undo_setup
  ...
  --------------------
  TODO : set the value for column
  FUNC : xfp2SeverityLaserFault_set
  ...
  ---------------------
  TODO : undo set for column
  FUNC : xfp2SeverityLaserFault_undo
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      xfp2SeverityTable table.

      Conversely, the examples below may not include some functions that
      were generated for the xfp2SeverityTable table.

To watch the flow of the xfp2SeverityTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        xfp2SeverityTable
        verbose:xfp2SeverityTable
        internal:xfp2SeverityTable

e.g.
        snmpd -f -Le -Dxfp2SeverityTable,verbose:xfp2SeverityTable,internal:xfp2SeverityTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::xfp2SeverityEntry.xfp2SeverityIndex
 * xfp2SeverityIndex is subid 1 of xfp2SeverityEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.1.1.3.5.2.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE xfp2SeverityIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
