...
//  cs_uint32 hysteresis;
  ...
  if (rtn != CS_OK) { printf("Failed BEFORE ten_hl_n40g_config_mux_t41(), rc=%d\n", rtn);  return (CS_ERROR);}
...
if (rtn != CS_OK) { printf("Failed ten_hl_n40g_config_mux_t41, rc=%d\n", rtn);  return (CS_ERROR);}
...
if (rtn != CS_OK) { printf("Failed ten_mpif_global_clock_disable_n40g_n10g, rc=%d\n", rtn);  return (CS_ERROR);}
  ...
  rtn |= ten_hl_n10g_config_t41 (module_id_line, 
                                 ...
                                 term_oc192,
                                 tcm_line);
if (rtn != CS_OK) { printf("Failed ten_hl_n10g_config_t41 line, rc=%d\n", rtn); return (CS_ERROR); }
  ...
  rtn |= ten_hl_n10g_config_t41 (module_id_client, 
                                 ...
                                 term_oc192,
                                 tcm_line);
if (rtn != CS_OK) { printf("Failed ten_hl_n10g_config_t41 client, rc=%d\n", rtn);  return (CS_ERROR);}
  ...
  rtn |= ten_hl_xcon_config(dev_id, (module_id_line & 1) * 4 + slice_line, (module_id_client & 1) * 4 + slice_client, TEN_TRAFFIC_TYPE_OC192); 
if (rtn != CS_OK) { printf("Failed ten_hl_xcon_config, rc=%d\n", rtn);  return (CS_ERROR);}


  if ((dyn_repro == TEN_INITIAL_CONFIG) || (dyn_repro == TEN_REPRO_LINE_AND_CLIENT)) {
    /* Provision FEC and frame size */
    rtn |= ten_hl_config_fec_t41 (module_id_line, 0, TEN_SLICE_40G, fec_line);
if (rtn != CS_OK) { printf("Failed ten_hl_config_fec_t41() at end, rc=%d\n", rtn); return (CS_ERROR);}
  }
  return (rtn);
}
