...
------------------------------------------------------------------------
  ...
  the txpPowSupplyAlrmTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpPowSupplyAlrmTable.m2d, and then re-running mib2c.
    ...
    in the txpPowSupplyAlrmTable.h header.
    ...
    will be generated:
      ...
      txpPowSupplyAlrmTable_allocate_data
      txpPowSupplyAlrmTable_release_data
 ...
 Index(es) for the txpPowSupplyAlrmTable table
  ------------------------------------------------------------
  The index(es) for the txpPowSupplyAlrmTable table are:

     txpPowSupplyAlrmIndex:
        Syntax:      OCTETSTR
        DataType:    OCTETSTR
...
************************************************************************
txpPowSupplyAlrmTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpPowSupplyAlrmTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpPowSupplyAlrmTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpPowSupplyAlrmTable_data_access file contains the interface to your data in
  ...
  FUNC : txpPowSupplyAlrmTable_indexes_set
  WHERE: txpPowSupplyAlrmTable_data_access.c
...
File: txpPowSupplyAlrmTable_enums.h
------------------------------------------------------------------------
...
File: txpPowSupplyAlrmTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpPSUMMARY_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpP5VANALOG_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpN5V2ANALOG_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpP3P3VANALOG_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpP3P3VDIGITAL_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpLVDIGITAL_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpN5P2VDIGITAL_get



File: txpPowSupplyAlrmTable_data_set.c
------------------------------------------------------------------------
...
************************************************************************
txpPowSupplyAlrmTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      txpPowSupplyAlrmTable table.

      Conversely, the examples below may not include some functions that
      were generated for the txpPowSupplyAlrmTable table.

To watch the flow of the txpPowSupplyAlrmTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpPowSupplyAlrmTable
        verbose:txpPowSupplyAlrmTable
        internal:txpPowSupplyAlrmTable

e.g.
        snmpd -f -Le -DtxpPowSupplyAlrmTable,verbose:txpPowSupplyAlrmTable,internal:txpPowSupplyAlrmTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpPowSupplyAlrmEntry.txpPowSupplyAlrmIndex
 * txpPowSupplyAlrmIndex is subid 1 of txpPowSupplyAlrmEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.1.3.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpPowSupplyAlrmIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
