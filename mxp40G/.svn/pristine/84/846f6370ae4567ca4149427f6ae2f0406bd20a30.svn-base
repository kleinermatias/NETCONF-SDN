...
/* strictly prohibited.                                                */
/* Copyright (c) 2002-2013 by Cortina Systems Incorporated.            */
/***********************************************************************/
/*
 * cs_rtos.h
 *
 ...
 *
 * $Id: cs_rtos.h,v 1.22 2013/02/20 13:25:05 ktleinfe Exp $
 */
...
CS_INLINE  cs_uint16 CS_REG_READ(volatile cs_uint16 * pReg)
{
   ...
   */
#ifdef T41_EVB_SDK
  return ((cs_uint16)cs_phy_read_reg(T41_SYS_ID, (int)((cs_uint32)pReg)>>1));
#else
/*
#ifdef _GPIO_T41_CHECK_
  return gpio_t41_read(pReg);
#else
  return (*pReg);
#endif
*/
...
CS_INLINE  void  CS_REG_WRITE(volatile cs_uint16 * pReg, cs_uint16 data)
{
   ...
   */
#ifdef T41_EVB_SDK
  cs_phy_write_reg(T41_SYS_ID, (int)((cs_uint32)pReg>>1), data);
#else
/*
#ifdef _GPIO_T41_CHECK_
  gpio_t41_write(pReg, data);
#else
  *pReg = data ;
#endif
*/
