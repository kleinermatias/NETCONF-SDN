...
------------------------------------------------------------------------
  ...
  the txpPhyspadTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpPhyspadTable.m2d, and then re-running mib2c.
    ...
    in the txpPhyspadTable.h header.
    ...
    will be generated:
      ...
      txpPhyspadTable_allocate_data
      txpPhyspadTable_release_data
 ...
 Index(es) for the txpPhyspadTable table
  ------------------------------------------------------------
  The index(es) for the txpPhyspadTable table are:
...
************************************************************************
txpPhyspadTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpPhyspadTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpPhyspadTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpPhyspadTable_data_access file contains the interface to your data in
  ...
  FUNC : txpPhyspadTable_indexes_set
  WHERE: txpPhyspadTable_data_access.c
...
File: txpPhyspadTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpInterrupt_get



File: txpPhyspadTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      txpPhyspadTable table.

      Conversely, the examples below may not include some functions that
      were generated for the txpPhyspadTable table.

To watch the flow of the txpPhyspadTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpPhyspadTable
        verbose:txpPhyspadTable
        internal:txpPhyspadTable

e.g.
        snmpd -f -Le -DtxpPhyspadTable,verbose:txpPhyspadTable,internal:txpPhyspadTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpPhyspadEntry.txpPhyspadIndex
 * txpPhyspadIndex is subid 1 of txpPhyspadEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.2.5.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpPhyspadIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
