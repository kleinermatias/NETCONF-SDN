 ...
 * ten_gen_data.h
 *
 * $Id: ten_gen_data.h,v 1.81 2013/02/22 20:48:25 jccarlis Exp $
 *
...
#define TEN_CHIP_ID_CS6041          (0x100913e5)    /* T41 dev id = 9 */
...
#define TEN_HSIF_LOOPBACK_SETTINGS_STRUCT_VERSION_NUM (5110)
typedef struct {
...
typedef struct {
  ...
  cs_uint16 ten_bus_error_count; /* Bugilla #26434 */
  cs_uint16 ten_bus_error_ctl; /* Bugilla #26434 */
} ten_drvr_cb_t;
