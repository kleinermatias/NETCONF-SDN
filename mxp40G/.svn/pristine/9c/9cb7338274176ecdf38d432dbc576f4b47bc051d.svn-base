...
begin with the txpPowSupplyAlrmTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : txpPowSupplyAlrmTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f txpPowSupplyAlrmTable_Makefile


  File    : txpPowSupplyAlrmTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   txpPowSupplyAlrmTable-README-txpPowSupplyAlrmTable.txt
...
------------------------------------------------------------------------
  ...
  File    : txpPowSupplyAlrmTable_interface.c
