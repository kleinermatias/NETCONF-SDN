 ...
 *
 * $Id: ten_hl_hsif_cfp.c,v 1.61 2014/03/23 23:35:56 pptawade Exp $
 *
 */
...
/********************************************************************/
{
  ...
  case (TEN_TRAFFIC_TYPE_OTU2EX4):             /*66 */  /* Bugzilla 43359 */
  ...
  /* Buzilla 39690 Start */
  if ((traffic == TEN_TRAFFIC_TYPE_2GFC) ||
      (traffic == TEN_TRAFFIC_TYPE_2GISC) ||
      (traffic == TEN_TRAFFIC_TYPE_CPRI_4)) {
    /* DDIV=2 (divide by 4) */
    tmp_srx0_rx_clkdiv_ctrl_ddiv_sel   = 2;
    tmp_stxp0_tx_clkdiv_ctrl_ddiv_sel  = 2;
  } else if (traffic == TEN_TRAFFIC_TYPE_4GFC) {
    /* DDIV=1 (divide by 2) */
    tmp_srx0_rx_clkdiv_ctrl_ddiv_sel   = 1;
    tmp_stxp0_tx_clkdiv_ctrl_ddiv_sel  = 1;
  } else if ((traffic == TEN_TRAFFIC_TYPE_1GFC) ||
             (traffic == TEN_TRAFFIC_TYPE_1GE)) {
    /* DDIV=3 (divide by 8) */
  ...
  case (TEN_TRAFFIC_TYPE_CPRI_4): /* Bugzilla 39690 - Highest table value for 12.288 Gbps */
    cfp_vco_thres = 0x20;  /* default */
    /* GBPS_2__125_FC */
    break;
  ...
  for (ii=0; ii<8; ii++) {
    ...
    if ((slice == (ii%4)) || (slice == TEN_SLICE_ALL)) {
      ...
      if ((traffic == TEN_TRAFFIC_TYPE_2GFC) ||
          (traffic == TEN_TRAFFIC_TYPE_2GISC) ||
          (traffic == TEN_TRAFFIC_TYPE_CPRI_4)) {
        ten_hl_gpllx1_init(dev_id, instance+ii, TEN_HL_GPLL_MODE_XFI_2GFC, 0);
      } else if (traffic == TEN_TRAFFIC_TYPE_4GFC) {
        ten_hl_gpllx1_init(dev_id, instance+ii, TEN_HL_GPLL_MODE_XFI_4GFC, 0);
      } else if ((traffic == TEN_TRAFFIC_TYPE_1GFC) ||
                 (traffic == TEN_TRAFFIC_TYPE_1GE)) {
        ten_hl_gpllx1_init(dev_id, instance+ii, TEN_HL_GPLL_MODE_XFI_1GFC, 0);
      } else {
