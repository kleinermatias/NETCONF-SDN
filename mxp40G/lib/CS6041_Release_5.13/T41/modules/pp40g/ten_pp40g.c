 ...
 * ten_pp40g.c 
 *
 * $Id: ten_pp40g.c,v 1.32 2014/03/24 00:08:02 pptawade Exp $
 *
 * API's for PP40G 
 *
 */
...
/********************************************************************/
/* $rtn_hdr_start  PP40G CONTROL TX SUBBLOCKS T41                   */
/* CATEGORY   : API                                                 */
/* ACCESS     : Public                                              */
/* BLOCK      : PP40G                                               */
/* CHIP       : Tenabo                                              */
cs_status ten_pp40g_ctrl_tx_subblks_t41(cs_uint16 module_id,
                                        cs_uint16 sub_blk,
                                        cs_ctl_t ctl)
/* INPUTS     : o Module Id                                         */
/*              o Sub Block                                         */
...
/* RETURNS    : CS_OK or CS_ERROR                                   */
/* DESCRIPTION:                                                     */
/* Enable or disable PP40G TX path sub-blocks                       */
/*                                                                  */
/*   [sub_blk] specifies the type of block defined by               */
/*             ten_pp40g_tx_sub_block_e enumeration                 */
/*     TEN_PP40G_TX_BLK_PBT      = 0x01                             */
/*     TEN_PP40G_TX_BLK_PCS_PRA  = 0x02                             */
/*     TEN_PP40G_TX_BLK_PCS_BDB  = 0x04                             */
/*     TEN_PP40G_TX_BLK_PCS_MGB  = 0x08                             */
/*     TEN_PP40G_TX_BLK_PCS_XEC  = 0x10                             */
/*     TEN_PP40G_TX_BLK_PCS_FPG  = 0x20                             */
/*     TEN_PP40G_TX_BLK_PCS_ITP  = 0x40                             */
/*     TEN_PP40G_TX_BLK_PCS_BIL  = 0x80                             */
/*                                                                  */
/* The [ctl] parameter enables or disables the selected sub-block   */
/*   0 = CS_DISABLE                                                 */
/*   1 = CS_ENABLE                                                  */
/*                                                                  */
/* $rtn_hdr_end                                                     */
/********************************************************************/
{
  ...
  CS_PRINT("ten_pp40g_ctrl_tx_subblks_t41\n");
  
  /* Parameter Checking */
  if (sub_blk > 0xFF) {
    CS_HNDL_ERROR(module_id, ETEN_DEV_INVALID_USER_ARG,
                             ": ten_pp40g_ctrl_tx_subblks_t41 Param2");
    return(CS_ERROR);
  }

  if (ctl > 1) {
    CS_HNDL_ERROR(module_id, ETEN_DEV_INVALID_USER_ARG,
                             ": ten_pp40g_ctrl_tx_subblks_t41 Param3");
    return(CS_ERROR);
  }
  ...
  if((sub_blk>>1) & 0x01) {
    tmp_pp40g_misc_tx_clken.bf.clken_pra = ctl;
    tmp_pp40g_misc_tx_funcen.bf.fen_pra = ctl;
  }
  if((sub_blk>>2) & 0x01) {
    tmp_pp40g_misc_tx_clken.bf.clken_bdb = ctl;
    tmp_pp40g_misc_tx_funcen.bf.fen_bdb = ctl;
  }
  if((sub_blk>>3) & 0x01) {
    tmp_pp40g_misc_tx_clken.bf.clken_mgb = ctl;
    tmp_pp40g_misc_tx_funcen.bf.fen_mgb = ctl;
  }
  if((sub_blk>>4) & 0x01) {
    tmp_pp40g_misc_tx_clken.bf.clken_xec = ctl;
    tmp_pp40g_misc_tx_funcen.bf.fen_xec = ctl;
  }
  if((sub_blk>>5) & 0x01) {
    tmp_pp40g_misc_tx_clken.bf.clken_fpg = ctl;
    tmp_pp40g_misc_tx_funcen.bf.fen_fpg = ctl;
  }
  if((sub_blk>>6) & 0x01) {
    tmp_pp40g_misc_tx_funcen.bf.fen_itp = ctl;
  }
  if((sub_blk>>7) & 0x01) {
    tmp_pp40g_misc_tx_funcen.bf.fen_bil = ctl;
  }      
...
/********************************************************************/
/* $rtn_hdr_start  PP40G CONTROL RX SUBBLOCKS T41                   */
/* CATEGORY   : API                                                 */
/* ACCESS     : Public                                              */
/* BLOCK      : PP40G                                               */
/* CHIP       : Tenabo                                              */
cs_status ten_pp40g_ctrl_rx_subblks_t41(cs_uint16 module_id,
                                        cs_uint16 sub_blk,
                                        cs_ctl_t ctl)
/* INPUTS     : o Module Id                                         */
/*              o Sub Block                                         */
...
/* RETURNS    : CS_OK or CS_ERROR                                   */
/* DESCRIPTION:                                                     */
/* Enable or disable RX path sub-blocks                             */
/*                                                                  */
/*   [sub_blk] specifies the type of block defined by               */
/*             ten_pp40g_rx_sub_block_e enumeration                 */
/*     TEN_PP40G_RX_BLK_LIF          = 0x1                          */
/*     TEN_PP40G_RX_BLK_PCS_DIL      = 0x2                          */
/*     TEN_PP40G_RX_BLK_PCS_LBA      = 0x4                          */
/*     TEN_PP40G_RX_BLK_PCS_LDS      = 0x8                          */
/*     TEN_PP40G_RX_BLK_PCS_LRO      = 0x10                         */
/*     TEN_PP40G_RX_BLK_PCS_MBA      = 0x20                         */
/*     TEN_PP40G_RX_BLK_PCS_XDC      = 0x40                         */
/*     TEN_PP40G_RX_BLK_PCS_BDS_RXI  = 0x80                         */
/*     TEN_PP40G_RX_BLK_PCS_BDS_BDC  = 0x100                        */
/*     TEN_PP40G_RX_BLK_PCS_BDC      = 0x200                        */
/*     TEN_PP40G_RX_BLK_PCS_TPC      = 0x400                        */
/*     TEN_PP40G_RX_BLK_PCS_NRA      = 0x800                        */
/*     TEN_PP40G_RX_BLK_RS           = 0x1000                       */
/*     TEN_PP40G_RX_BLK_MAC          = 0x2000                       */
/*                                                                  */
/* The [ctl] parameter enables or disables the selected sub-block   */
/*   0 = CS_DISABLE                                                 */
/*   1 = CS_ENABLE                                                  */
...
/********************************************************************/
{
  ...
  CS_PRINT("ten_pp40g_ctrl_rx_subblks_t41\n");
  
  /* Parameter Checking */
  if (sub_blk > 0x2FFF) {
    CS_HNDL_ERROR(module_id, ETEN_DEV_INVALID_USER_ARG,
                             ": ten_pp40g_ctrl_rx_subblks_t41 Param2");
    return(CS_ERROR);
  }

  if (ctl > 1) {
    CS_HNDL_ERROR(module_id, ETEN_DEV_INVALID_USER_ARG,
                             ": ten_pp40g_ctrl_rx_subblks_t41 Param3");
    return(CS_ERROR);
  }
  ...
  TEN_MOD_COMMON_VALIDATE(module_id, pDev, CS_ERROR);
  TEN_MOD_LOCK(module_id, TEN_ID_PP40G);
  tmp_pp40g_misc_rx_clken.wrd = TEN_REG_READ(TEN_PP40G_REG_ADDR(pDev, module_id, misc_rx_CLKEN));
  tmp_pp40g_misc_rx_funcen.wrd = TEN_REG_READ(TEN_PP40G_REG_ADDR(pDev, module_id, misc_rx_FUNCEN));


  if((sub_blk >>13) & 0x01) { 
    tmp_pp40g_misc_rx_clken.bf.clken_mac = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_mac = ctl;
  }
  if((sub_blk>>12) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_rs = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_rs = ctl;
  }
  if((sub_blk>>11) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_nra = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_nra = ctl;
  }
  if((sub_blk>>10) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_tpc = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_tpc = ctl;
  }
  if((sub_blk>>9) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_bdc = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_bdc = ctl;
  }
  if((sub_blk>>8) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_bds = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_bds_bdc = ctl;
  }
  if((sub_blk>>7) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_bds = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_bds_rxi = ctl;
  }
  if((sub_blk>>6) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_xdc = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_xdc = ctl;
  }
  if((sub_blk>>5) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_mba = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_mba = ctl;
  }
  if((sub_blk>>4) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_lro = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_lro = ctl;
  }
  if((sub_blk>>3) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_lds = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_lds = ctl;
  }
  if((sub_blk>>2) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_lba = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_lba = ctl;
  }
  if((sub_blk>>1) & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_dil = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_dil = ctl;
  }
  if(sub_blk & 0x01) {
    tmp_pp40g_misc_rx_clken.bf.clken_lif = ctl;
    tmp_pp40g_misc_rx_funcen.bf.fen_lif = ctl;
  }
...
/******************************************************************************/
/* $rtn_hdr_start   PP40G_MISC_PP40G_DESKEW_DISABLE                           */
/* CATEGORY   : API                                                           */
/* ACCESS     : Public                                                        */
/* BLOCK      : PP40G                                                         */
/* CHIP       : Tenabo                                                        */
cs_status ten_pp40g_misc_pp40g_deskew_disable_t41(cs_uint16 module_id)
/* INPUTS     : o Module_id                                                   */
/* OUTPUTS    : ----                                                          */
/* RETURNS    : CS_OK or CS_ERROR                                             */
/* DESCRIPTION:                                                               */
/* Disable PP40G deskew logic for monolitic 40G dewrapping                    */
/* $rtn_hdr_end                                                               */
/******************************************************************************/
{
  TEN_PP40G_MISC_CLKEN_t tmp_pp40g_misc_clken;
  ...
  tmp_pp40g_misc_bypass.wrd = TEN_REG_READ(TEN_PP40G_REG_ADDR(pDev, module_id, BYPASS));
  tmp_pp40g_misc_bypass.bf.rx_dsk_en = 0;
  TEN_REG_WRITE(TEN_PP40G_REG_ADDR(pDev, module_id, BYPASS), tmp_pp40g_misc_bypass.wrd);
...
/* Bugzilla 43359 Start */
/********************************************************************/
/* $rtn_hdr_start  PP40G SET RX PCS SKEW THRESHOLD                  */
/* CATEGORY   : API                                                 */
/* ACCESS     : Public                                              */
/* BLOCK      : PP40G                                               */
/* CHIP       : Tenabo                                              */
cs_status ten_pp40g_set_pcs_rx_skew_thresh_t41(cs_uint16 module_id,
                                               cs_uint16 thresh)
/* INPUTS     : o Module Id                                         */
/*              o Threshold                                         */
/* OUTPUTS    : ----                                                */
/* RETURNS    : CS_OK or CS_ERROR                                   */
/* DESCRIPTION:                                                     */
/* Configures the maximum allowable skew and is defined in terms of */
/* 33 bit quantities.                                               */
/*                                                                  */
/* The [thresh] parameter selects skew threshold specified as bits: */ 
/*   0 - 16383                                                      */
/* The actual skew is 33 x <thresh> bits. The value of skew         */
/* threshold <thresh> must be increased by the width of ODU2e/      */
/* OTU2e/FEC overhead slot to compensate.                           */
/*                                                                  */
/* $rtn_hdr_end                                                     */
/********************************************************************/
{ 
  ...
  CS_PRINT("ten_pp40g_set_pcs_rx_skew_thresh_t41\n");
  
  /* Parameter Checking */
  if (thresh > 0x3FFF) {
    CS_HNDL_ERROR(module_id, ETEN_DEV_INVALID_USER_ARG,
                             ": ten_pp40g_set_pcs_rx_skew_thresh_t41 Param2");
    return(CS_ERROR);
  }
  ...
  TEN_REG_WRITE(TEN_PP40G_REG_ADDR(pDev, module_id, SKEWTHRESHOLD), thresh);
