...
------------------------------------------------------------------------
  ...
  the edfaTable table.  The agent will start by looking for the right
  ...
  file defaults/table-edfaTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      edfaTable_allocate_data
      edfaTable_release_data
 ...
 Index(es) for the edfaTable table
  ------------------------------------------------------------
  The index(es) for the edfaTable table are:
...
************************************************************************
edfaTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the edfaTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: edfaTable_data_access.[c|h]
------------------------------------------------------------------------
  The edfaTable_data_access file contains the interface to your data in
  ...
  FUNC : edfaTable_indexes_set
  WHERE: edfaTable_data_access.c
...
------------------------------------------------------------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : edfaAmpStat_get



File: edfaTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the edfaTable table.

To watch the flow of the edfaTable table, use the
...
e.g.
        snmpd -f -Le -DedfaTable,verbose:edfaTable,internal:edfaTable
 ...
 **********************************************************************/
/*
 * FTNC-MIB::edfaTable is subid 8 of mxpMIBObjects.
 * Its status is Current.
 * OID: .1.3.6.1.4.1.43484.2.8, length: 9
*/

/*---------------------------------------------------------------------
 * FTNC-MIB::edfaEntry.edfaIndex
 * edfaIndex is subid 1 of edfaEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.8.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE edfaIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
