 ...
 * $Id:$
 */
#ifndef XFP1SEVERITYTABLE_DATA_ACCESS_H
#define XFP1SEVERITYTABLE_DATA_ACCESS_H
...
int xfp1SeverityTable_init_data(xfp1SeverityTable_registration * xfp1SeverityTable_reg);
    ...
    /*
     * TODO:180:o: Review xfp1SeverityTable cache timeout.
     * The number of seconds before the cache times out
     */
#define XFP1SEVERITYTABLE_CACHE_TIMEOUT   1

void xfp1SeverityTable_container_init(netsnmp_container **container_ptr_ptr,
                             netsnmp_cache *cache);
...
int xfp1SeverityTable_cache_load(netsnmp_container *container);
void xfp1SeverityTable_cache_free(netsnmp_container *container);
...
#endif /* XFP1SEVERITYTABLE_DATA_ACCESS_H */
