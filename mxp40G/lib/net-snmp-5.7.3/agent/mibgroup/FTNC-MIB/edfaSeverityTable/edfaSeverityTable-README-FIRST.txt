...
begin with the edfaSeverityTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : edfaSeverityTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f edfaSeverityTable_Makefile


  File    : edfaSeverityTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   edfaSeverityTable-README-edfaSeverityTable.txt
...
------------------------------------------------------------------------
  ...
  File    : edfaSeverityTable_interface.c
