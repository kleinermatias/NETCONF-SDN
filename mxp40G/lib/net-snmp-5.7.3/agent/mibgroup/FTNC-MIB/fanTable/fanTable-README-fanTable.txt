...
------------------------------------------------------------------------
  ...
  the fanTable table.  The agent will start by looking for the right
  ...
  file defaults/table-fanTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      fanTable_allocate_data
      fanTable_release_data
 ...
 Index(es) for the fanTable table
  ------------------------------------------------------------
  The index(es) for the fanTable table are:
...
************************************************************************
fanTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the fanTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: fanTable_data_access.[c|h]
------------------------------------------------------------------------
  The fanTable_data_access file contains the interface to your data in
  ...
  FUNC : fanTable_indexes_set
  WHERE: fanTable_data_access.c
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the fanTable table.

To watch the flow of the fanTable table, use the
...
e.g.
        snmpd -f -Le -DfanTable,verbose:fanTable,internal:fanTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::fanEntry.fanIndex
 * fanIndex is subid 1 of fanEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.2.1.1
 * Description:
The auxiliary variable used for identifying instances
            of the columnar objects in the fanTable
 *
 * Attributes:
