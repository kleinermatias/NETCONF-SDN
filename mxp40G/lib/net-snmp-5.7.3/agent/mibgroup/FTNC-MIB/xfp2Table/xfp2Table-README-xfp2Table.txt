...
------------------------------------------------------------------------
  ...
  the xfp2Table table.  The agent will start by looking for the right
  ...
  file defaults/table-xfp2Table.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      xfp2Table_allocate_data
      xfp2Table_release_data
 ...
 Index(es) for the xfp2Table table
  ------------------------------------------------------------
  The index(es) for the xfp2Table table are:
...
************************************************************************
xfp2Table File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the xfp2Table
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: xfp2Table_data_access.[c|h]
------------------------------------------------------------------------
  The xfp2Table_data_access file contains the interface to your data in
  ...
  FUNC : xfp2Table_indexes_set
  WHERE: xfp2Table_data_access.c
...
------------------------------------------------------------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2LowTxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2HighTxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2LowRxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2HighRxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2RxCdrLol_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2TxCdrLol_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp2LasFault_get



File: xfp2Table_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the xfp2Table table.

To watch the flow of the xfp2Table table, use the
...
e.g.
        snmpd -f -Le -Dxfp2Table,verbose:xfp2Table,internal:xfp2Table
...
/*---------------------------------------------------------------------
 * FTNC-MIB::xfp2Entry.xfp2Index
 * xfp2Index is subid 1 of xfp2Entry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.4.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE xfp2Index IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
