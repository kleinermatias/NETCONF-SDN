...
begin with the txpDSPCompensationTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : txpDSPCompensationTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f txpDSPCompensationTable_Makefile


  File    : txpDSPCompensationTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   txpDSPCompensationTable-README-txpDSPCompensationTable.txt
...
------------------------------------------------------------------------
  ...
  File    : txpDSPCompensationTable_interface.c
