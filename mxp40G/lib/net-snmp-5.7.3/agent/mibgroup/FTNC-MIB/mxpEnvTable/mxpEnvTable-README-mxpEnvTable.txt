...
------------------------------------------------------------------------
  ...
  the mxpEnvTable table.  The agent will start by looking for the right
  ...
  file defaults/table-mxpEnvTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      mxpEnvTable_allocate_data
      mxpEnvTable_release_data
 ...
 Index(es) for the mxpEnvTable table
  ------------------------------------------------------------
  The index(es) for the mxpEnvTable table are:
...
************************************************************************
mxpEnvTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the mxpEnvTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: mxpEnvTable_data_access.[c|h]
------------------------------------------------------------------------
  The mxpEnvTable_data_access file contains the interface to your data in
  ...
  FUNC : mxpEnvTable_indexes_set
  WHERE: mxpEnvTable_data_access.c
...
File: mxpEnvTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpTempT41Around_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpTempT41TS0_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpTempT41TS1_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpTempT41TS2_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpTempFPGA_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpTempBOARD_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpTempEdfa_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : mxpHumedity_get



File: mxpEnvTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the mxpEnvTable table.

To watch the flow of the mxpEnvTable table, use the
following debug tokens:
        ...
        mxpEnvTable
        verbose:mxpEnvTable
        internal:mxpEnvTable

e.g.
        snmpd -f -Le -DmxpEnvTable,verbose:mxpEnvTable,internal:mxpEnvTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::mxpEnvEntry.mxpEnvIndex
 * mxpEnvIndex is subid 1 of mxpEnvEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.7.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE mxpEnvIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
