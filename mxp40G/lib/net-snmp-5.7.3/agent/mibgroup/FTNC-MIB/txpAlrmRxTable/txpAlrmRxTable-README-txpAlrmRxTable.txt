...
------------------------------------------------------------------------
  ...
  the txpAlrmRxTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpAlrmRxTable.m2d, and then re-running mib2c.
    ...
    in the txpAlrmRxTable.h header.
    ...
    will be generated:
      ...
      txpAlrmRxTable_allocate_data
      txpAlrmRxTable_release_data
 ...
 Index(es) for the txpAlrmRxTable table
  ------------------------------------------------------------
  The index(es) for the txpAlrmRxTable table are:
...
************************************************************************
txpAlrmRxTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpAlrmRxTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpAlrmRxTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpAlrmRxTable_data_access file contains the interface to your data in
  ...
  FUNC : txpAlrmRxTable_indexes_set
  WHERE: txpAlrmRxTable_data_access.c
...
File: txpAlrmRxTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpRxALMINT_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpRxPOWALM_get
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpPRBSERRDET_get



File: txpAlrmRxTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      txpAlrmRxTable table.

      Conversely, the examples below may not include some functions that
      were generated for the txpAlrmRxTable table.

To watch the flow of the txpAlrmRxTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpAlrmRxTable
        verbose:txpAlrmRxTable
        internal:txpAlrmRxTable

e.g.
        snmpd -f -Le -DtxpAlrmRxTable,verbose:txpAlrmRxTable,internal:txpAlrmRxTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpAlrmRxEntry.txpAlrmRxIndex
 * txpAlrmRxIndex is subid 1 of txpAlrmRxEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.1.2.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpAlrmRxIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
