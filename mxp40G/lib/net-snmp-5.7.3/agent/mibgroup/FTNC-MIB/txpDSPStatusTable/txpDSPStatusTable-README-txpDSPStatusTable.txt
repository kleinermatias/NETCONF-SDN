...
------------------------------------------------------------------------
  ...
  the txpDSPStatusTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpDSPStatusTable.m2d, and then re-running mib2c.
    ...
    in the txpDSPStatusTable.h header.
    ...
    will be generated:
      ...
      txpDSPStatusTable_allocate_data
      txpDSPStatusTable_release_data
 ...
 Index(es) for the txpDSPStatusTable table
  ------------------------------------------------------------
  The index(es) for the txpDSPStatusTable table are:
...
************************************************************************
txpDSPStatusTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpDSPStatusTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpDSPStatusTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpDSPStatusTable_data_access file contains the interface to your data in
  ...
  FUNC : txpDSPStatusTable_indexes_set
  WHERE: txpDSPStatusTable_data_access.c
...
File: txpDSPStatusTable_enums.h
------------------------------------------------------------------------
...
File: txpDSPStatusTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dspInitialized_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : presenceOfLight_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : localOscillatorRunning_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : transmitLaserRunning_get



File: txpDSPStatusTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      txpDSPStatusTable table.

      Conversely, the examples below may not include some functions that
      were generated for the txpDSPStatusTable table.

To watch the flow of the txpDSPStatusTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpDSPStatusTable
        verbose:txpDSPStatusTable
        internal:txpDSPStatusTable

e.g.
        snmpd -f -Le -DtxpDSPStatusTable,verbose:txpDSPStatusTable,internal:txpDSPStatusTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpDSPStatusEntry.txpDSPStatusIndex
 * txpDSPStatusIndex is subid 1 of txpDSPStatusEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.3.1.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpDSPStatusIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
