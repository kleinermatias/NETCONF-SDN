...
------------------------------------------------------------------------
  ...
  the txpChannelTable table.  The agent will start by looking for the right
  ...
  file defaults/table-txpChannelTable.m2d, and then re-running mib2c.
    ...
    in the txpChannelTable.h header.
    ...
    will be generated:
      ...
      txpChannelTable_allocate_data
      txpChannelTable_release_data
 ...
 Index(es) for the txpChannelTable table
  ------------------------------------------------------------
  The index(es) for the txpChannelTable table are:
...
************************************************************************
txpChannelTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the txpChannelTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: txpChannelTable_data_access.[c|h]
------------------------------------------------------------------------
  The txpChannelTable_data_access file contains the interface to your data in
  ...
  FUNC : txpChannelTable_indexes_set
  WHERE: txpChannelTable_data_access.c
...
File: txpChannelTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpTxLaserITUChannel_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : txpRxLaserITUChannel_get



File: txpChannelTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      txpChannelTable table.

      Conversely, the examples below may not include some functions that
      were generated for the txpChannelTable table.

To watch the flow of the txpChannelTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        txpChannelTable
        verbose:txpChannelTable
        internal:txpChannelTable

e.g.
        snmpd -f -Le -DtxpChannelTable,verbose:txpChannelTable,internal:txpChannelTable
...
/*---------------------------------------------------------------------
 * FTNC-MIB::txpChannelEntry.txpChannelIndex
 * txpChannelIndex is subid 1 of txpChannelEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.9.2.3.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE txpChannelIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
