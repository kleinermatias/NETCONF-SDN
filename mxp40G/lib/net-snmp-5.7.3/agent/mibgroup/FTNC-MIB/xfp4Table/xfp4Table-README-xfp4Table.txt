...
------------------------------------------------------------------------
  ...
  the xfp4Table table.  The agent will start by looking for the right
  ...
  file defaults/table-xfp4Table.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      xfp4Table_allocate_data
      xfp4Table_release_data
 ...
 Index(es) for the xfp4Table table
  ------------------------------------------------------------
  The index(es) for the xfp4Table table are:
...
************************************************************************
xfp4Table File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the xfp4Table
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: xfp4Table_data_access.[c|h]
------------------------------------------------------------------------
  The xfp4Table_data_access file contains the interface to your data in
  ...
  FUNC : xfp4Table_indexes_set
  WHERE: xfp4Table_data_access.c
...
------------------------------------------------------------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp4LowTxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp4HighTxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp4LowRxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp4HighRxPow_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp4RxCdrLol_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp4TxCdrLol_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : xfp4LasFault_get



File: xfp4Table_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the xfp4Table table.

To watch the flow of the xfp4Table table, use the
...
e.g.
        snmpd -f -Le -Dxfp4Table,verbose:xfp4Table,internal:xfp4Table
...
/*---------------------------------------------------------------------
 * FTNC-MIB::xfp4Entry.xfp4Index
 * xfp4Index is subid 1 of xfp4Entry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.43484.2.6.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE xfp4Index IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
