...
#    '40gelan_otu3e'              => [ 3, 128, -1 ],
    ...
    '40gep_otu3'                 => [ 4, 11, 0 ],
    '40gep_otu3e'                => [ 1, 128, 0 ],     # otu3e should be treated as otu3e1, invalid as per G.709
    '40gep_otu3+'                 => [ 4, 541, 0 ],     # Transcoded
    '40gex_otu3+'                 => [ 4, 541, 0 ],     # Transcoded  28006
    '40gep_otu3e2'                => [ 4, 175, 0 ],
    '40gep_ra_otu3'              => [ 1, 128, 0 ],
    '40gep_ra_otu3e'             => [ 1, 128, 0 ],
...
#    '40gesbi_otu3e'              => [ 1, 128, 0 ],     # otu3e should be treated as otu3e1, invalid as per G.709
    ...
    '40gesbi_ra_otu3'            => [ 1, 128, 0 ],
    '40gesbi_ra_otu3e'           => [ 1, 128, 0 ],
...
#    '40ges6466_otu3e'            => [ 1, 128, 0 ],     # otu3e should be treated as otu3e1, invalid as per G.709
    ...
    '40ges6466_ra_otu3'          => [ 1, 128, 0 ],
    '40ges6466_ra_otu3e'         => [ 1, 128, 0 ],
