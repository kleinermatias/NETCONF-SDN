 ...
 *
 * $Id: ten_hl_cupll.c,v 1.57 2013/02/22 20:44:11 jccarlis Exp $
 *
...
/********************************************************************/
{
  ...
  if (coeffin <= 0) {
   ...
   /* JUST_LOG_1(LOG_INFO, "T41",  "shift = %lx\n",  shift); */
   return shift;
}
...
/********************************************************************/
{
  ...
  cs_uint32 out = 1;
   ...
   /* JUST_LOG_2(LOG_INFO, "T41",  "ten_cupll_two_pow %d = %d\n",  in, out); */
   return out;
}
...
/********************************************************************/
{
  ...
  if (verbose == 1) {
    JUST_LOG_1(LOG_INFO, "T41", "Fline:  %f\n", Fline);
    JUST_LOG_1(LOG_INFO, "T41", "Fref:   %f\n", Fref);
    JUST_LOG_1(LOG_INFO, "T41", "Fsync:  %f\n", Fsync);
    JUST_LOG_1(LOG_INFO, "T41", "Fsynth: %f\n", Fsynth);
    JUST_LOG_1(LOG_INFO, "T41", "preloadfint:  %32x\n", preloadfint);
    JUST_LOG_1(LOG_INFO, "T41", "preloadffrac: %32x\n", preloadffrac);
    JUST_LOG_1(LOG_INFO, "T41", "subrate_div: %d\n", subrate_div);
    JUST_LOG(LOG_INFO, "T41", "-------------\n");
    JUST_LOG_1(LOG_INFO, "T41", "k1f     : %f\n", k1f);
    JUST_LOG_1(LOG_INFO, "T41", "z1f     : %f\n", z1f);
    JUST_LOG_1(LOG_INFO, "T41", "p1f     : %f\n", p1f);
    JUST_LOG_1(LOG_INFO, "T41", "p2f     : %f\n", p2f);
    JUST_LOG_1(LOG_INFO, "T41", "p3f     : %f\n\n", p3f);
    JUST_LOG_1(LOG_INFO, "T41", "k1s     : %f\n", k1s);
    JUST_LOG_1(LOG_INFO, "T41", "z1s     : %f\n", z1s);
    JUST_LOG_1(LOG_INFO, "T41", "p1s     : %f\n", p1s);
    JUST_LOG_1(LOG_INFO, "T41", "p2s     : %f\n", p2s);
    JUST_LOG_1(LOG_INFO, "T41", "p3s     : %f\n", p3s);
    JUST_LOG(LOG_INFO, "T41", "-------------\n");
    JUST_LOG_1(LOG_INFO, "T41", "k1fscale: %16x\n", k1fscale);
    JUST_LOG_1(LOG_INFO, "T41", "k1fshift: %16x\n", k1fshift);
    JUST_LOG_1(LOG_INFO, "T41", "z1fscale: %16x\n", z1fscale);
    JUST_LOG_1(LOG_INFO, "T41", "z1fshift: %16x\n", z1fshift);
    JUST_LOG_1(LOG_INFO, "T41", "p1fscale: %16x\n", p1fscale);
    JUST_LOG_1(LOG_INFO, "T41", "p1fshift: %16x\n", p1fshift);
    JUST_LOG_1(LOG_INFO, "T41", "p2fscale: %16x\n", p2fscale);
    JUST_LOG_1(LOG_INFO, "T41", "p2fshift: %16x\n", p2fshift);
    JUST_LOG_1(LOG_INFO, "T41", "p3fscale: %16x\n", p3fscale);
    JUST_LOG_1(LOG_INFO, "T41", "p3fshift: %16x\n\n", p3fshift);
    JUST_LOG_1(LOG_INFO, "T41", "k1sscale: %16x\n", k1sscale);
    JUST_LOG_1(LOG_INFO, "T41", "k1sshift: %16x\n", k1sshift);
    JUST_LOG_1(LOG_INFO, "T41", "z1sscale: %16x\n", z1sscale);
    JUST_LOG_1(LOG_INFO, "T41", "z1sshift: %16x\n", z1sshift);
    JUST_LOG_1(LOG_INFO, "T41", "p1sscale: %16x\n", p1sscale);
    JUST_LOG_1(LOG_INFO, "T41", "p1sshift: %16x\n", p1sshift);
    JUST_LOG_1(LOG_INFO, "T41", "p2sscale: %16x\n", p2sscale);
    JUST_LOG_1(LOG_INFO, "T41", "p2sshift: %16x\n", p2sshift);
    JUST_LOG_1(LOG_INFO, "T41", "p3sscale: %16x\n", p3sscale);
    JUST_LOG_1(LOG_INFO, "T41", "p3sshift: %16x\n", p3sshift);
  }
...
/********************************************************************/
{
  ...
  const double Fline_subrate          = 8500000000.0;
  const cs_uint32 freq_subrate_max    = 311040000;
  cs_boolean div_freq_by_2            = FALSE;    
  ...
  Fline     = pdevcb->cupll_cb.rate;
   freq      = pdevcb->cupll_cb.freq;
  if ((freq > freq_max) || ((Fline <= Fline_subrate) && (freq >= freq_subrate_max))) {
    div_freq_by_2 = TRUE;
  }
