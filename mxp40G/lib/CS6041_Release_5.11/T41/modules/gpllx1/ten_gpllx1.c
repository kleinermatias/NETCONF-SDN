 ...
 *
 * $Id: ten_gpllx1.c,v 1.19 2013/02/22 21:01:47 jccarlis Exp $
 *
 */
...
/****************************************************************/
{
  ...
  if (ten_dev_is_t41(dev_id)) {
    ...
    ten_gpllx1_txvco0_thres1 (dev_id, instance, 0, 0); /* TXVCO_THRES1  VCO Coarse Tuning Algorithm Threshold for VCO 1 */
  }
  else { 
