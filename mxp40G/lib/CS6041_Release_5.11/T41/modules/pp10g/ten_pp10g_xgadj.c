 ...
 * ten_pp10g_xgadj.c
 *
 * $Id: ten_pp10g_xgadj.c,v 1.10 2013/02/22 20:48:04 jccarlis Exp $
 *
...
/********************************************************************/
{
  ...
  for (sl=0; sl<TEN_MAX_SLICES; sl++) {
    if ((slice == sl) || (slice == TEN_SLICE_ALL)) {
      tmp_xgadj_tx_insert_access_0.wrd = TEN_REG_READ(TEN_PP10G_XGADJ_REG_ADDR(pDev, module_id, sl, INSERT_ACCESS_0));
      tmp_xgadj_tx_insert_access_0.bf.data_0 = data_0;
...
/********************************************************************/
{
  ...
  for (sl=0; sl<TEN_MAX_SLICES; sl++) {
    if ((slice == sl) || (slice == TEN_SLICE_ALL)) {
      tmp_xgadj_tx_insert_access_n.wrd = TEN_REG_READ(TEN_PP10G_XGADJ_REG_ADDR(pDev, module_id, sl, INSERT_ACCESS_N));
      tmp_xgadj_tx_insert_access_n.bf.data_n = data_n;
