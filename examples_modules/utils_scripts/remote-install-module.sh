...
if [ "$arch" == "nios2" ]; then
	nios2-linux-gnu-gcc -shared  -fPIC -DPIC  -I. -I../../compile_yuma123/$arch/output/usrapp/include/yuma/agt -I../../compile_yuma123/$arch/output/usrapp/include/yuma/ncx -I../../compile_yuma123/$arch/output/usrapp/include/yuma/platform -I../../compile_yuma123/$arch/output/usrapp/include/libxml2 -I../../compile_yuma123/$arch/output/usrapp/include/libxml2/libxml -rdynamic ../$module/$module.c ../../compile_yuma123/$arch/output/usrapp/lib/libyumancx.so ../../compile_yuma123/$arch/output/usrapp/lib/libyumaagt.so ../../compile_yuma123/$arch/output/usrapp/lib/libxml2.so -ldl -O0 -o ../$module/$libmodule.so
elif [ "$arch" == "arm" ]; then
