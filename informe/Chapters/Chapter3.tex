...
\subsection{Diagrama en bloques del \textit{muxponder}}

A continuación, se presenta en la figura \ref{fig:diagramabloque} un diagrama en bloques del \textit{muxponder} donde se observan los principales componentes que conforman el mismo.

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.77]{Figures/monitorapp.png}
	\caption{Diagrama en bloques del \textit{muxponder} 40GB.}
